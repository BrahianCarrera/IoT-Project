/**
 * Custom Material 3 color palettes for light and dark modes.
 * Based on a green nature-inspired theme.
 */
export const Colors = {
  light: {
    // Primary colors for buttons, icons, and main elements
    "primary": "rgb(16, 109, 32)",
    "onPrimary": "rgb(255, 255, 255)",
    "primaryContainer": "rgb(157, 248, 152)",
    "onPrimaryContainer": "rgb(0, 34, 4)",

    // Secondary colors for secondary buttons, filters, etc.
    "secondary": "rgb(82, 99, 79)",
    "onSecondary": "rgb(255, 255, 255)",
    "secondaryContainer": "rgb(213, 232, 206)",
    "onSecondaryContainer": "rgb(17, 31, 15)",

    // Tertiary colors for accents/highlights
